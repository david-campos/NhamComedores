...
<div class="row" id="rCalendario" style="display:none;">
	<table id="tCalendario" class="calendario centered">
		<thead>
			<tr><th><?php // Mis platos iran aqui ?></th><th id="calYear" colspan="7">Año de prueba</th></tr>
			<tr>
				<th><?php // Mis platos iran aqui ?></th>
				<th id="calMonth" colspan="5">Mes de prueba</th>
				<th id="calBefore"><a class="btn light-green disabled"><i class="material-icons">navigate_before</i></a></th>
				<th id="calNext"><a class="btn light-green disabled"><i class="material-icons">navigate_next</i></a></th>
			</tr>
			<tr>
				<th class="misPlatos"><a class="btn amber white-text"><i class="material-icons">keyboard_arrow_up</i></a></th>
				<th>L</th><th>Ma</th><th>Mi</th><th>J</th><th>V</th><th>S</th><th>D</th>
			</tr>
		</thead>
		<tfoot>
			<tr>
				<td class="misPlatos"><a class="btn amber white-text"><i class="material-icons">keyboard_arrow_down</i></a></td>
				<td colspan="7">
					<div class="progress light-green lighten-3" style="display: none;"><div class="indeterminate light-green"></div></div>
				</td>
			</tr>
		</tfoot>
		<tbody>
...
<script language="JavaScript">
	<?php
		// Proveemos información del comedor y de sus platos
		$lineas = obtenerLineas(0, null);
		for($i=0;$i<count($lineas);$i++) {
			$com = $lineas['respuesta'][$i];
			if($com['_id'] ==  $_SESSION['id_comedor']) {
				printf("const COMEDOR = %s;", json_encode($com));
				break;
			}
		}
		$platos = obtenerMisPlatos($_SESSION['id_comedor'], 0, 100);
		printf("const MIS_PLATOS = %s;", json_encode($platos));
	?>
</script>
<script language="JavaScript" src="/js/calendario.js"></script>
<script language="JavaScript" src="/js/calendario_acciones.js"></script>
<?php
	} else {
?>
