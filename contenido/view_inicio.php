    ...
    <div id="contenido" class="row">
        <ul class="collection" id="listaComedores">
            ...
            for ($i = 0; $i < count($comedores); ++$i) {
                ...
                <p>Apertura: <?php echo normalizaHora($comedores[$i]['hAperturaIni']) ?>
                    - <?php echo normalizaHora($comedores[$i]['hAperturaFin']) ?> |
                    Comedor: <?php echo normalizaHora($comedores[$i]['horaInicio']) ?>
                    - <?php echo normalizaHora($comedores[$i]['horaFin']) ?>
                </p>
                </li>
                <?php
            }
            ...
            <div class="section">
                ...
                <div class="section">
                    ...
                    <div class="row white" id="primeros">
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<b>Ensalada</b><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDe
